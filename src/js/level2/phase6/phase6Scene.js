...
fireHole4.position.set(gridMapHelper.getGlobalXPositionFromCoord(7),1.5,gridMapHelper.getGlobalZPositionFromCoord(2))
gridMapHelper.addFireHole(7,5)
gridMapHelper.addFireHole(5,0)
gridMapHelper.addFireHole(9,0)
gridMapHelper.addFireHole(7,2)
...
function alternateFire()
{
    ...
    if(gridMapHelper.fireHoles[0].active)
    {
